...
const experiences = [
  {
    ...
    highlights: [
      "Sole engineer on-call — every production incident, deployment, and recovery is mine to own end-to-end",
      "Java 21, Spring Boot, Spring WebFlux with OAuth 2.0 and JWT-secured REST APIs",
      "AI-assisted development workflows (Copilot, Claude, Codex) — 2-3x throughput on solo backend work",
      "MongoDB Atlas indexing tuned for ~60% lower listing-endpoint latency; sub-200ms p95",
      "Stripe integration with idempotent webhooks — zero duplicate-charge incidents in production",
      "GitHub Actions CI/CD with rollback playbooks and pre-prod smoke tests",
    ],
  },
  {
    role: "Java Backend Developer | Associate Consultant",
    company: "Infrasoft Technologies (FinTech vendor to global tier-1 banks)",
    period: "Nov 2021 – Oct 2024",
    location: "Mumbai, India",
    highlights: [
      "AML/ATF, Anti-Fraud (AFS), and IFRS 9 microservices — Java, Spring Boot, REST + SOAP",
      "Real-time UN/OFAC/EU/HMT sanctions screening for KYC and customer onboarding",
      "Apache Kafka event streaming + Pentaho/Informatica ETL into regulatory analytics",
      "Oracle PL/SQL for IFRS 9 ECL automation; MongoDB tuning for 90%+ fraud detection",
      "L3 production support, RCA, DB tuning, and multi-country UAT/production go-lives",
    ],
  },
  {
    role: "Software Developer | L3 Support Engineer",
    company: "Onward e-Services (Client: Bank of Maharashtra — ~30M+ customers, 2,200+ branches)",
    period: "Feb 2020 – Oct 2021",
    location: "Pune, India",
    highlights: [
      "Java + PL/SQL backend for Core Banking, Remittances, and Payments (SWIFT, NEFT, RTGS)",
      "EOD/SOD batch monitoring and high-volume ATM file-based transaction processing",
      "24x7 L3 support — log analysis, RCA, and emergency change deployments under banking SLAs",
    ],
  },
  {
    role: "Assistant Systems Analyst",
    company: "C-Edge Technologies (TCS–SBI JV; Client: NABARD-supervised cooperative banks)",
    period: "Mar 2018 – Feb 2020",
    location: "Mumbai, India",
    highlights: [
      "General Ledger, Deposits, and Trickle Feed modules using PL/SQL, COBOL, and Java",
      "Autosys batch monitoring and Shell scripting for 100+ regional cooperative banks",
      "SQL performance tuning and on-site post-implementation support",
    ],
  },
]
